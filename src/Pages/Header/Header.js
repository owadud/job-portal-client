...
const Header = () => {
    ...
    const menuItems = <>
        ...
        <li>{user && <Link to='/addjob'>Add Job</Link>}</li>
    ...
    return (
        <div className="navbar bg-base-100 bg-neutral text-neutral-content">
            <div className="navbar-start">
                ...
                <a href="/#" className="btn btn-ghost normal-case text-xl">Find Jobs</a>
            </div>
            ...
            <div className='navbar-end'>
                <label tabIndex="1" htmlFor="sidebar" className="btn btn-ghost lg:hidden">
